...
def write_release(root=ROOT, creation_timestamp="2026-08-31T00:00:00Z"):
    ...
    obj={"version":"v0.4.2b6","content_manifest_sha256":digest(cm),"frozen_g6_manifest_sha256":G6,"creation_timestamp":creation_timestamp,"functional_capabilities":caps,"live_execution_decision":"V042B6_ENCODED_IMAGE_TO_OMNI_TO_FOCUS_VERIFIED"}
